...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', 'ADMINS= 6230751739 1877279215 5023815012 5906684391 5039863679 6067718572').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb://cljqyos890012ajmgbdqvcs2i:uK8Jv3ENBv9YnOv4GuevPxYi@104.237.3.174:9005/?readPreference=primary&ssl=false")
...
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1001929422367').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "Hello {mention}\nWelcome To {title}\n\nsend /start to approve Your request thankyou for join us")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001884812882 -1001826345112 -1001770760604 -1001510729517 -1001839273638 -1001886641107 -1001343778771')).split()]
